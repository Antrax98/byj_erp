...
import dev.byjtech.erp.modules.document_management.features.documents.nav.documentsMain.DocumentsMainHomeScreen
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Children(
            ...
            when (val child = it.instance) {
                is DocumentsFeatureComponent.Child.DocumentsHome -> DocumentsMainHomeScreen(child.component)
                is DocumentsFeatureComponent.Child.DocumentsList -> DocumentsMainScreen(child.component)
