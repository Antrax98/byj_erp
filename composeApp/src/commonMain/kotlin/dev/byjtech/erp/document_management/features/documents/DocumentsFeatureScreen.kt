...
import dev.byjtech.erp.document_management.features.documents.nav.documentsMain.DocumentsMainScreen
...
fun DocumentPageScreen(component: Any) {
    Box(modifier = Modifier.fillMaxSize()) {
        Text("Página de Documento - ID: ${(component as dev.byjtech.erp.document_management.features.documents.nav.documentPage.DocumentPageComponent).documentId}")
    }
}
...
fun EditDocumentScreen(component: Any) {
    Box(modifier = Modifier.fillMaxSize()) {
        Text("Editar Documento - ID: ${(component as dev.byjtech.erp.document_management.features.documents.nav.editDocument.EditDocumentComponent).documentId}")
    }
}
