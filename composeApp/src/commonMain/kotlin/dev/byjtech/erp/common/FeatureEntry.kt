...
data class FeatureEntry(
    ...
    val requiredAnyPermissions: Set<PermissionKey>, //permisos que requiere el feature
    val optionalPermissions: Set<PermissionKey> = emptySet(), //permisos opcionales que requiere el feature
